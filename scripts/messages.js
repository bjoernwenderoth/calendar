let messages = [
	["Was tippst du da soviel?! Was machst du da?! - Jetzt weißt du es :P<br>Da mir die Idee vielleicht etwas spontan kam, musste noch einiges getan werden :D."],
	["Christmas, children, is not a date. It is a state of mind.", "Ich liebe dich!"],
	["Christmas waves a magic wand over this world, and behold, everything is softer and more beautiful.", "Norman Vincent Peale"],
	["Blessed is the season which engages the whole world in a conspiracy of love.", "Hamilton Wright Mabie"],
	["A lovely thing about Christmas is that it's compulsory, like a thunderstorm, and we all go through it together.", "Garrison Keillor"],
	["Christmas is a necessity. There has to be at least one day of the year to remind us that we're here for something else besides ourselves.", "Eric Seleteid"],
